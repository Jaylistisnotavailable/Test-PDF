// src/core/coordinate/engineeringScale.ts

export const PDF_POINTS_PER_INCH = 72;

export const MM_PER_INCH = 25.4;

export const PT_TO_MM =
  MM_PER_INCH /
  PDF_POINTS_PER_INCH;

export const MM_TO_PT =
  PDF_POINTS_PER_INCH /
  MM_PER_INCH;
...
export function mmToEngineeringUnit(
  mm: number,
...
export function engineeringUnitToMm(
  value: number,
  unit: EngineeringUnit,
): number {
  if (unit === 'm') {
...
export function isValidDrawingScale(
  numerator: number,
  denominator: number,
): boolean {
  return (
