...
export class BeamTool extends BaseTool{
 ...
 onMouseDown(e:CanvasEvent,ctx:ToolContext){if(!this.start){this.start=e;const d=STRUCTURAL_DEFAULTS.beam;const label=ensureLabel(ctx,'beam');ctx.setTempShape({...makeBase(ctx,'beam',{start:e,end:e,width:d.width,depth:d.depth}),label,properties:{label,section:d.section,material:d.material}});}}
